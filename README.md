...
> 단, **설계 판단과 구현 방향은 개발자가 직접 결정**했습니다.
...
<details>
<summary><b>자세히 보기</b> — 교정 전/후 수치, 하드웨어 티어별 산출 근거, Quantum을 교정하지 않은 이유</summary>
...
<details>
<summary><b>디버깅 과정 자세히 보기</b> — 문제 표, 재검증 결과, 가용성 가드</summary>
