...
export default function App() {
  ...
  return (
    <div className={`app-root h-screen overflow-hidden flex flex-col bg-bg-main font-main p-3 md:p-5 text-text-base transition-colors duration-500`}>
